                ...
                <div id="mySidenav" class="sidenav">
                    ...
                    <?php echo "<a href=". site_url() . "/dejavnost/mojeDejavnosti" . ">"?><i class="fas fa-angle-right"></i> <?php echo "Aktualne dejavnosti</a>" ?>
                    <?php echo "<a href=". site_url() . "/dejavnost/zakljuceneDejavnostiProfesor" . ">"?><i class="fas fa-angle-right"></i> <?php echo "Zaključene dejavnosti</a>" ?>
