                <nav class="navbar navigacija sticky-top">
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <h1 class="dropdown-header">Prijavljeni ste kot <?php  echo $this->session->userdata("ime")?></h1>
                ...
                <div id="mySidenav" class="sidenav">
                    ...
                    <?php echo "<a href=". site_url() . "/dejavnost/vseDejavnosti" . ">"?><i class="fas fa-angle-right"></i> <?php echo "Aktualne dejavnosti</a>" ?>
                    <?php echo "<a href=". site_url() . "/dejavnost/zakljuceneDejavnostiAdmin" . ">"?><i class="fas fa-angle-right"></i> <?php echo "Zaključene dejavnosti</a>" ?>
                    ...
                    <?php echo "<a href=". site_url() . "/prijava/urejanjeUporabnikov" . ">"?><i class="fas fa-angle-right"></i> <?php echo "Urejanje uporabnikov</a>" ?>
                    <br>
